...
source_folder="/data/project/STAR/STAR_preprocessed/L_OnsDur/"
destination_folder="/data/project/STAR/STAR_preprocessed/L_fmriprep/data/derivatives/"
...
for file in "${source_folder}"*.mat; do
    ...
    if [[ -n "$sub_id" ]]; then
        ...
        destination_dir="${destination_folder}${sub_id}/ses-mri01/func/"
